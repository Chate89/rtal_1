...
function draw() {
  ...
  text(x3, medx-boxsizex/2+275, medy-upi-boxsizey/2-10);
    ...
    fill(15,25,35);
    rect(medx+400-5, medy+27-upi, 30, 280, 10, 10, 10, 10);
    slixM = medx+400-5;
    sliyM = medy+27-upi;
    syM = 320;
    ...
    mouseX>=slixM-15 && mouseX<=slixM+15) {
      mrm = mouseY;
      fill(79, 105, 132);
      rect(fadePosxM, mrm, 35, 10, 5, 5, 5, 5);
    } else {
      fill(39, 72, 104);
      rect(fadePosxM, mrm, 35, 10, 5, 5, 5, 5);
    }
    fill(30,50,70);
    rect(medx+390, 156-upi, 64, 40, 0, 20, 0, 20);
    fill(150);
    textSize(30);
    nMas = (sliyM+135-mrm)*100/270;
    nMasF = nMas.toFixed(0);
    text(nMasF, slixM-4, 168-upi);
    mv = nMasF/100
    masterVolume(mv);
    console.log(mv);
    ...
    // vumetro 1
    vol1 = amp1.getLevel();
    vol1histM.push(vol1/(6.3-(upi/110)));
    ...
    // vumetro 2
    vol2 = amp2.getLevel();
    vol2histM.push(vol2/(6.3-(upi/110)));
    stroke(255, nMasF*2.55);
    noFill();
    beginShape();
    ...
    // vumetro 3
    vol3 = amp3.getLevel();
    vol3histM.push(vol3/(6.3-(upi/110)));
    stroke(255, nMasF*2.55);
    noFill();
    beginShape();
